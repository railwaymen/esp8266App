...
static const char *ssid = "mroczne_modrzewie";   // your wi-fi name
static const char *password = "Palanienalanie2"; // your wi-fi password

static const uint8_t PIN = 12;
static const uint8_t LEDS_N = 8;

ESP8266WebServer server(80);
Adafruit_NeoPixel strip = Adafruit_NeoPixel(LEDS_N, PIN, NEO_GRB + NEO_KHZ800);
